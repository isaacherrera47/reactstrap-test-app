...
import {Card, CardBody, Collapse, Media, Nav, NavItem, NavLink} from 'reactstrap';
                    ...
                    <Media>
                        ...
                        <Media body className="vehicleData">
                            ...
                            <Nav>
                                <NavItem>
                                    <NavLink
                                        onClick={this.toggle}>{this.state.collapse ? "See Less" : "See More"}</NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink data-model={vehicle.detailKey} data-color-name={vehicle.colors[0][0]}
                                             data-msrp={vehicle.msrp}
                                             onClick={this.props.selectVehicle}>Select</NavLink>
                                </NavItem>
                            </Nav>
                        </Media>
                    </Media>
